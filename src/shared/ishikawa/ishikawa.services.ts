...
export class IshikawaServices<T extends Document> {
    ...
    async create(data: createIshikawaRequest) {
    ...
    async update(id: string, data: Partial<createIshikawaRequest>) {
    ...
    async getByLibrary(
        ...
        const matchQuery: any = { library: new mongoose.Types.ObjectId(libraryId) };
