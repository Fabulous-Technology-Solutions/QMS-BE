...
router
    .route('/')
    .post(auth('createChecklist'), checkCreateRole, validate(ValidationChecklist.checkListValidationSchema), ChecklistController.createChecklist)
...
router
    ...
    .patch(auth('updateChecklist'), checkCreateRole, validate(ValidationChecklist.checkListUpdateValidationSchema), ChecklistController.updateChecklist)
