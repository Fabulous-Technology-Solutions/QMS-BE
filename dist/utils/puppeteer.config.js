...
async function cleanupCorruptedChromium() {
    try {
        const fs = require('fs');
    ...
    if (isTrueServerless) {
        ...
        try {
            return await puppeteer_core_1.default.launch({
                args: [...chromium_1.default.args, '--disable-web-security'],
    ...
    if (isAWSEC2 || isDocker || isLinux || process.env['AWS_LAMBDA_FUNCTION_NAME']) {
        ...
        try {
            ...
            try {
                ...
                const chromiumPath = await chromium_1.default.executablePath();
                ...
                return await puppeteer_core_1.default.launch({
                    args: [...chromium_1.default.args, '--disable-web-security', '--no-sandbox'],
                    defaultViewport: { width: 1920, height: 1080 },
