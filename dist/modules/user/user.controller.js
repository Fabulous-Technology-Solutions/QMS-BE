...
const subscription_service_2 = require("../subscription/subscription.service");
...
exports.getMe = (0, catchAsync_1.default)(async (req, res) => {
    ...
    if (user.role !== 'admin') {
        ...
        subscription = await (0, subscription_service_2.getSubAdminModules)(getModules);
    }
    else {
        subscription = await (0, subscription_service_1.getUserSubscription)(userId);
    }
