...
const NotificationSettingSchema = new mongoose_1.Schema({
    workspaceId: { type: mongoose_1.default.Types.ObjectId, required: true, unique: true },
...
const NotificationSettingModal = mongoose_1.default.model('NotificationSetting', NotificationSettingSchema);
exports.default = NotificationSettingModal;
