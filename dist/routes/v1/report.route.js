...
router.get('/workspace/:workspaceId/library/:libraryId', (0, auth_1.auth)('getLibraryReports'), mangeRole_middleware_1.default, report_1.reportController.getReportsByLibraryController);
