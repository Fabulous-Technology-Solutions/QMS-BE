...
router.get("/libraries/:libraryId/attachments", (0, auth_1.auth)("Risk_getAttachmentsByWorkspace"), risklibrary_middleware_1.default, attachment_1.AttachmentController.getByLibrary);
